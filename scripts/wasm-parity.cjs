...
const fixtures = [
  { file: "docx/body-pagination.docx", granularity: "element", exact: true },
  ...
  { file: "docx/wrappers.docx", granularity: "element", exact: true },
  ...
  { file: "broken-encoding.pdf", granularity: "" },
  { file: "cjk.pdf", granularity: "" },
